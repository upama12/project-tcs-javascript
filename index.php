...
<style type="text/css">
    ...
    #bg{
        ...
        background-image: url(imagewebsite.png);
...
<body>
    <div id="navbar">
        ...
        <h2>ABCD Consultancy Services</h2>
        <ul>
            <li>Home</li>
            <li>About</li>
            <li>Contact</li>
    ...
    <div id="text">
        <p><b>ABCD Consultancy Services</b> is an Indian multinational information technology services and consulting company headquartered in xyz, India with its largest campus located in Chennai, Tamil Nadu, India. ABCD is the largest IT services company in the world by market capitalisation.</p>
    </div>
